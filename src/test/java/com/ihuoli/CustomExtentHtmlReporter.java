 ...
 */
public class CustomExtentHtmlReporter extends BasicFileReporter implements ReportAppendable {
    
    private static final Logger logger = Logger.getLogger(CustomExtentHtmlReporter.class.getName());

    private static final String TEMPLATE_LOCATION = "../../html-report";
    ...
    public CustomExtentHtmlReporter(String filePath) {
        this();
        this.filePath = filePath;
        config().setFilePath(filePath);
    }
    
    public CustomExtentHtmlReporter(File file) {
    ...
    private Configuration getConfig() {
        ...
        cfg.setClassForTemplateLoading(CustomExtentHtmlReporter.class, TEMPLATE_LOCATION);
